// <copyright file="PayPalRESTAPIsClient.cs" company="APIMatic">
...
using PayPalRESTAPIs.Standard.Logging;
...
namespace PayPalRESTAPIs.Standard
{
    ...
    /// </summary>
    public sealed class PayPalRESTAPIsClient : IConfiguration
    {
        ...
        private const string userAgent = "PayPal REST API DotNet SDK, Version: 0.4.0-beta, on OS {os-info}";
        ...
        /// <summary>
        /// Creates an object of the PayPalRESTAPIsClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> PayPalRESTAPIsClient.</returns>
        internal static PayPalRESTAPIsClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("PAY_PAL_RESTAP_IS_STANDARD_ENVIRONMENT");
            string oAuthClientId = System.Environment.GetEnvironmentVariable("PAY_PAL_RESTAP_IS_STANDARD_O_AUTH_CLIENT_ID");
            string oAuthClientSecret = System.Environment.GetEnvironmentVariable("PAY_PAL_RESTAP_IS_STANDARD_O_AUTH_CLIENT_SECRET");
        ...
        {
            private Environment environment = PayPalRESTAPIs.Standard.Environment.Sandbox;
